...
if [ ! -d "$FOLDER_PATH" ]; then
    ...
    #echo req --base "${FOLDER_PATH}" --req-dir "${FOLDER_PATH}/req" --guidelines-dir "${FOLDER_PATH}/guidelines" --doc-dir "${FOLDER_PATH}/docs" --test-dir "${FOLDER_PATH}/tests" --src-dir "${FOLDER_PATH}/src" --src-dir ".github/workflows" --write-guidelines --enable-claude --enable-codex --enable-gemini --enable-github --enable-kiro --enable-opencode --enable-models --enable-tools --legacy
