...
| 2026-02-16 | 0.75 | Rimossi i template guideline predefiniti dal pacchetto e aggiornata la gestione `--add-guidelines`/`--upgrade-guidelines` per supportare directory sorgente guideline vuota senza errore. |
