...
- **SRS-350**: MUST print a bright-red stderr diagnostic for HTTP release-check failures; on HTTP 429 or on HTTP 403 with response message containing `API rate limit exceeded`, it MUST persist an 86400-second idle-delay.
