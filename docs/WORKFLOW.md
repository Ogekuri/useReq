...
- **Internal Call-Trace Tree**
  - `main(...)`: command router and execution coordinator [`src/usereq/cli.py`]
    ...
    - `_is_project_scan_command(...)`: detect project-scan command path including git and worktree commands [`src/usereq/cli.py`]
      ...
      - `run_git_path(...)`: execute `--git-path` and print absolute git repository root derived from current cwd context [`src/usereq/cli.py`]
        - `_resolve_git_repository_root_from_cwd(...)`: resolve repository root or raise canonical not-found error [`src/usereq/cli.py`]
        - `resolve_git_root(...)`: query git root from filesystem context [`src/usereq/cli.py`]
      - `run_git_parent_path(...)`: execute `--git-parent-path` and print absolute parent path of the resolved repository root [`src/usereq/cli.py`]
        - `_resolve_git_repository_root_from_cwd(...)`: resolve repository root or raise canonical not-found error [`src/usereq/cli.py`]
        - `resolve_git_root(...)`: query git root from filesystem context [`src/usereq/cli.py`]
