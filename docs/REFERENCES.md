...
# cli.py | Python | 4804L | 147 symbols | 32 imports | 233 comments
...
### fn `def parse_args(argv: Optional[list[str]] = None) -> Namespace` (L534-543)
...
### fn `def load_package_version() -> str` (L544-558)
...
### fn `def maybe_print_version(argv: list[str]) -> bool` (L559-571)
...
### fn `def run_upgrade() -> None` (L572-598)
...
### fn `def run_uninstall() -> None` (L599-622)
...
### fn `def normalize_release_tag(tag: str) -> str` (L623-635)
...
### fn `def parse_version_tuple(version: str) -> tuple[int, ...] | None` (L636-660)
...
### fn `def is_newer_version(current: str, latest: str) -> bool` (L661-679)
...
### fn `def parse_github_owner_repository(remote_url: str) -> tuple[str, str] | None` (L680-706)
...
### fn `def read_git_remote_verbose(cwd: str | None = None) -> str` (L707-726)
...
### fn `def resolve_github_owner_repository_from_active_remotes() -> tuple[str, str]` (L727-787)
...
### fn `def resolve_latest_release_api_url() -> str` (L788-796)
...
### fn `def format_unix_timestamp_utc(timestamp_seconds: int) -> str` (L797-809)
...
### fn `def get_release_check_idle_file_path(` (L810-811)

### fn `def read_release_check_idle_state(file_path: Path) -> dict[str, int | str] | None` (L823-887)
...
### fn `def should_execute_release_check(` (L888-890)

### fn `def parse_retry_after_seconds(` (L908-910)
...
### fn `def write_release_check_idle_state_payload(` (L940-943)
...
### fn `def write_release_check_idle_state(` (L969-972)
...
### fn `def write_rate_limited_release_check_idle_state(` (L990-995)
...
### fn `def maybe_notify_newer_version(` (L1029-1030)
...
### fn `def ensure_doc_directory(path: str, project_base: Path) -> None` (L1161-1183)
...
### fn `def ensure_test_directory(path: str, project_base: Path) -> None` (L1184-1206)
...
### fn `def ensure_src_directory(path: str, project_base: Path) -> None` (L1207-1229)
...
### fn `def make_relative_if_contains_project(path_value: str, project_base: Path) -> str` (L1230-1271)
...
### fn `def resolve_absolute(normalized: str, project_base: Path) -> Optional[Path]` (L1272-1287)
...
### fn `def format_substituted_path(value: str) -> str` (L1288-1299)
...
### fn `def compute_sub_path(` (L1300-1301)

### fn `def resolve_git_root(target_path: Path) -> Path` (L1322-1349)
...
### fn `def is_inside_git_repo(target_path: Path) -> bool` (L1350-1369)
...
### fn `def sanitize_branch_name(branch: str) -> str` (L1370-1379)
...
### fn `def validate_wt_name(wt_name: str) -> bool` (L1380-1391)
...
### fn `def load_full_config(project_base: Path) -> dict` (L1392-1411)
...
### fn `def save_config(` (L1412-1422)

### fn `def load_config(project_base: Path) -> dict[str, str | list[str]]` (L1466-1516)
...
### fn `def load_static_check_from_config(project_base: Path) -> dict` (L1517-1548)
...
### fn `def build_persisted_update_flags(args: Namespace) -> dict[str, bool]` (L1549-1562)
...
### fn `def load_persisted_update_flags(project_base: Path) -> dict[str, bool]` (L1563-1604)
...
### fn `def load_persisted_provider_specs(project_base: Path) -> list[str]` (L1605-1626)
...
### fn `def generate_guidelines_file_list(guidelines_dir: Path, project_base: Path) -> str` (L1627-1659)
...
### fn `def generate_guidelines_file_items(` (L1660-1661)

### fn `def upgrade_guidelines_templates(guidelines_dest: Path, overwrite: bool = False) -> int` (L1695-1729)
...
### fn `def make_relative_token(raw: str, keep_trailing: bool = False) -> str` (L1730-1746)
...
### fn `def ensure_relative(value: str, name: str, code: int) -> None` (L1747-1762)
...
### fn `def apply_replacements(text: str, replacements: Mapping[str, str]) -> str` (L1763-1775)
...
### fn `def write_text_file(dst: Path, text: str) -> None` (L1776-1787)
...
### fn `def copy_with_replacements(` (L1788-1789)

### fn `def normalize_description(value: str) -> str` (L1804-1818)
...
### fn `def md_to_toml(md_path: Path, toml_path: Path, force: bool) -> None` (L1819-1853)
...
### fn `def extract_frontmatter(content: str) -> tuple[str, str]` (L1854-1867)
...
### fn `def extract_description(frontmatter: str) -> str` (L1868-1880)
...
### fn `def extract_argument_hint(frontmatter: str) -> str` (L1881-1893)
...
### fn `def extract_purpose_first_bullet(body: str) -> str` (L1894-1918)
...
### fn `def _extract_section_text(body: str, section_name: str) -> str` `priv` (L1919-1946)
...
### fn `def extract_skill_description(frontmatter: str) -> str` (L1947-1965)
...
### fn `def json_escape(value: str) -> str` (L1966-1975)
...
### fn `def generate_kiro_resources(` (L1976-1979)

### fn `def render_kiro_agent(` (L2005-2014)
...
### fn `def replace_tokens(path: Path, replacements: Mapping[str, str]) -> None` (L2060-2073)
...
### fn `def yaml_double_quote_escape(value: str) -> str` (L2074-2083)
...
### fn `def list_docs_templates() -> list[Path]` (L2084-2103)
...
### fn `def find_requirements_template(docs_templates: list[Path]) -> Path` (L2104-2120)
...
### fn `def load_kiro_template() -> tuple[str, dict[str, Any]]` (L2121-2160)
...
### fn `def strip_json_comments(text: str) -> str` (L2161-2185)
...
### fn `def load_settings(path: Path) -> dict[str, Any]` (L2186-2201)
...
### fn `def load_centralized_models(` (L2202-2205)

### fn `def get_model_tools_for_prompt(` (L2260-2261)
...
### fn `def get_raw_tools_for_prompt(config: dict[str, Any] | None, prompt_name: str) -> Any` (L2301-2322)
...
### fn `def format_tools_inline_list(tools: list[str]) -> str` (L2323-2334)
...
### fn `def deep_merge_dict(base: dict[str, Any], incoming: dict[str, Any]) -> dict[str, Any]` (L2335-2350)
...
### fn `def find_vscode_settings_source() -> Optional[Path]` (L2351-2362)
...
### fn `def build_prompt_recommendations(prompts_dir: Path) -> dict[str, bool]` (L2363-2377)
...
### fn `def ensure_wrapped(target: Path, project_base: Path, code: int) -> None` (L2378-2393)
...
### fn `def save_vscode_backup(req_root: Path, settings_path: Path) -> None` (L2394-2408)
...
### fn `def restore_vscode_settings(project_base: Path) -> None` (L2409-2424)
...
### fn `def prune_empty_dirs(root: Path) -> None` (L2425-2442)
...
### fn `def remove_generated_resources(project_base: Path) -> None` (L2443-2493)
...
### fn `def run_remove(args: Namespace) -> None` (L2494-2543)
...
### fn `def _validate_enable_static_check_command_executables(` `priv` (L2544-2547)

### fn `def run(args: Namespace) -> None` (L2576-2775)
...
- var `VERBOSE = args.verbose` (L2585)
- @brief Handles the main initialization flow.
- @details Validates input arguments, normalizes paths, and orchestrates resource generation per provider and artifact type. Requires at least one ``--provider`` spec (SRS-035). Deduplicates ``--enable-static-check`` entries (SRS-251, SRS-301).
- @param args Parsed CLI namespace; must contain ``provider_specs`` list and ``preserve_models`` boolean.
- @return {None} Function return value.
- @satisfies SRS-251, SRS-301
- var `DEBUG = args.debug` (L2586)
- var `PROMPT = prompt_path.stem` (L3070)
### fn `def _format_install_table(` `priv` (L3698-3700)

### fn `def _wrap_cell(value: str, width: int, allow_wrap: bool) -> list[str]` `priv` (L3737-3759)
...
### fn `def _render_row(provider: str, prompts: str, modules: str) -> list[str]` `priv` (L3760-3788)
...
### fn `def _build_provider_modules_map(provider_specs: list[str]) -> dict[str, list[str]]` `priv` (L3809-3848)
...
### fn `def _colorize_table_border(line: str) -> str` `priv` (L3849-3861)
...
- var `SUPPORTED_EXTENSIONS = frozenset(` (L3876)
### fn `def _collect_source_files(src_dirs: list[str], project_base: Path) -> list[str]` `priv` (L3904-3961)
...
### fn `def _build_ascii_tree(paths: list[str]) -> str` `priv` (L3962-4007)
...
### fn `def _emit(` `priv` (L3986-3988)
- @brief Build a deterministic tree string from project-relative paths.
- @details Implements the _build_ascii_tree function behavior with deterministic control flow.
- @param paths Project-relative file paths.
- @return Rendered tree rooted at '.'.

### fn `def _format_files_structure_markdown(files: list[str], project_base: Path) -> str` `priv` (L4008-4022)
...
### fn `def _is_standalone_command(args: Namespace) -> bool` `priv` (L4023-4041)
...
### fn `def _is_project_scan_command(args: Namespace) -> bool` `priv` (L4042-4064)
- @brief Check if the parsed args contain a project-scan command.
- @details Project-scan commands: `--references`, `--compress`, `--tokens`, `--find`, `--static-check`, `--git-check`, `--docs-check`, `--git-wt-name`, `--git-wt-create`, and `--git-wt-delete`.
- @param args Parsed CLI namespace.
- @return True when any project-scan flag is present.

### fn `def _is_here_only_project_scan_command(args: Namespace) -> bool` `priv` (L4065-4087)
- @brief Check if args request a project-scan command restricted to `--here` mode.
- @details Includes `--references`, `--compress`, `--tokens`, `--find`, `--static-check`, `--git-check`, `--docs-check`, `--git-wt-name`, `--git-wt-create`, and `--git-wt-delete`.
- @param args Parsed CLI namespace.
- @return True when command requires implicit `--here` and rejects `--base`.
- @satisfies SRS-311, SRS-313, SRS-318, SRS-320, SRS-326

### fn `def run_git_check(args: Namespace) -> None` (L4088-4122)
...
### fn `def run_docs_check(args: Namespace) -> None` (L4123-4152)
...
### fn `def run_git_wt_name(args: Namespace) -> None` (L4153-4181)
- @brief Execute --git-wt-name: print standardized worktree name.
- @param args Parsed CLI namespace.
- @return {None} Function return value.
- @satisfies SRS-318, SRS-319

### fn `def run_git_wt_create(args: Namespace) -> None` (L4182-4249)
...
### fn `def run_git_wt_delete(args: Namespace) -> None` (L4250-4329)
...
### fn `def run_files_tokens(files: list[str]) -> None` (L4330-4352)
...
### fn `def run_files_references(files: list[str]) -> None` (L4353-4369)
...
### fn `def run_files_compress(files: list[str], enable_line_numbers: bool = False) -> None` (L4370-4388)
...
### fn `def run_files_find(args_list: list[str], enable_line_numbers: bool = False) -> None` (L4389-4417)
...
### fn `def run_references(args: Namespace) -> None` (L4418-4435)
...
### fn `def run_compress_cmd(args: Namespace) -> None` (L4436-4457)
...
### fn `def run_find(args: Namespace) -> None` (L4458-4487)
...
### fn `def run_tokens(args: Namespace) -> None` (L4488-4515)
...
### fn `def run_files_static_check_cmd(files: list[str], args: Namespace) -> int` (L4516-4585)
...
### fn `def run_project_static_check_cmd(args: Namespace) -> int` (L4586-4631)
...
### fn `def _resolve_project_base(args: Namespace) -> Path` `priv` (L4632-4652)
...
### fn `def _resolve_project_src_dirs(args: Namespace) -> tuple[Path, list[str]]` `priv` (L4653-4705)
...
### fn `def main(argv: Optional[list[str]] = None) -> int` (L4706-4804)
...
- var `VERBOSE = getattr(args, "verbose", False)` (L4730)
- @brief CLI entry point for console_scripts and `-m` execution.
- @details Returns an exit code (0 success, non-zero on error).
- @param argv Input parameter `argv`.
- @return {int} Function return value.
- var `DEBUG = getattr(args, "debug", False)` (L4731)
## Symbol Index
|Symbol|Kind|Vis|Lines|Sig|
|---|---|---|---|---|
...
|`parse_args`|fn|pub|534-543|def parse_args(argv: Optional[list[str]] = None) -> Names...|
|`load_package_version`|fn|pub|544-558|def load_package_version() -> str|
|`maybe_print_version`|fn|pub|559-571|def maybe_print_version(argv: list[str]) -> bool|
|`run_upgrade`|fn|pub|572-598|def run_upgrade() -> None|
|`run_uninstall`|fn|pub|599-622|def run_uninstall() -> None|
|`normalize_release_tag`|fn|pub|623-635|def normalize_release_tag(tag: str) -> str|
|`parse_version_tuple`|fn|pub|636-660|def parse_version_tuple(version: str) -> tuple[int, ...] ...|
|`is_newer_version`|fn|pub|661-679|def is_newer_version(current: str, latest: str) -> bool|
|`parse_github_owner_repository`|fn|pub|680-706|def parse_github_owner_repository(remote_url: str) -> tup...|
|`read_git_remote_verbose`|fn|pub|707-726|def read_git_remote_verbose(cwd: str | None = None) -> str|
|`resolve_github_owner_repository_from_active_remotes`|fn|pub|727-787|def resolve_github_owner_repository_from_active_remotes()...|
|`resolve_latest_release_api_url`|fn|pub|788-796|def resolve_latest_release_api_url() -> str|
|`format_unix_timestamp_utc`|fn|pub|797-809|def format_unix_timestamp_utc(timestamp_seconds: int) -> str|
|`get_release_check_idle_file_path`|fn|pub|810-811|def get_release_check_idle_file_path(|
|`read_release_check_idle_state`|fn|pub|823-887|def read_release_check_idle_state(file_path: Path) -> dic...|
|`should_execute_release_check`|fn|pub|888-890|def should_execute_release_check(|
|`parse_retry_after_seconds`|fn|pub|908-910|def parse_retry_after_seconds(|
|`write_release_check_idle_state_payload`|fn|pub|940-943|def write_release_check_idle_state_payload(|
|`write_release_check_idle_state`|fn|pub|969-972|def write_release_check_idle_state(|
|`write_rate_limited_release_check_idle_state`|fn|pub|990-995|def write_rate_limited_release_check_idle_state(|
|`maybe_notify_newer_version`|fn|pub|1029-1030|def maybe_notify_newer_version(|
|`ensure_doc_directory`|fn|pub|1161-1183|def ensure_doc_directory(path: str, project_base: Path) -...|
|`ensure_test_directory`|fn|pub|1184-1206|def ensure_test_directory(path: str, project_base: Path) ...|
|`ensure_src_directory`|fn|pub|1207-1229|def ensure_src_directory(path: str, project_base: Path) -...|
|`make_relative_if_contains_project`|fn|pub|1230-1271|def make_relative_if_contains_project(path_value: str, pr...|
|`resolve_absolute`|fn|pub|1272-1287|def resolve_absolute(normalized: str, project_base: Path)...|
|`format_substituted_path`|fn|pub|1288-1299|def format_substituted_path(value: str) -> str|
|`compute_sub_path`|fn|pub|1300-1301|def compute_sub_path(|
|`resolve_git_root`|fn|pub|1322-1349|def resolve_git_root(target_path: Path) -> Path|
|`is_inside_git_repo`|fn|pub|1350-1369|def is_inside_git_repo(target_path: Path) -> bool|
|`sanitize_branch_name`|fn|pub|1370-1379|def sanitize_branch_name(branch: str) -> str|
|`validate_wt_name`|fn|pub|1380-1391|def validate_wt_name(wt_name: str) -> bool|
|`load_full_config`|fn|pub|1392-1411|def load_full_config(project_base: Path) -> dict|
|`save_config`|fn|pub|1412-1422|def save_config(|
|`load_config`|fn|pub|1466-1516|def load_config(project_base: Path) -> dict[str, str | li...|
|`load_static_check_from_config`|fn|pub|1517-1548|def load_static_check_from_config(project_base: Path) -> ...|
|`build_persisted_update_flags`|fn|pub|1549-1562|def build_persisted_update_flags(args: Namespace) -> dict...|
|`load_persisted_update_flags`|fn|pub|1563-1604|def load_persisted_update_flags(project_base: Path) -> di...|
|`load_persisted_provider_specs`|fn|pub|1605-1626|def load_persisted_provider_specs(project_base: Path) -> ...|
|`generate_guidelines_file_list`|fn|pub|1627-1659|def generate_guidelines_file_list(guidelines_dir: Path, p...|
|`generate_guidelines_file_items`|fn|pub|1660-1661|def generate_guidelines_file_items(|
|`upgrade_guidelines_templates`|fn|pub|1695-1729|def upgrade_guidelines_templates(guidelines_dest: Path, o...|
|`make_relative_token`|fn|pub|1730-1746|def make_relative_token(raw: str, keep_trailing: bool = F...|
|`ensure_relative`|fn|pub|1747-1762|def ensure_relative(value: str, name: str, code: int) -> ...|
|`apply_replacements`|fn|pub|1763-1775|def apply_replacements(text: str, replacements: Mapping[s...|
|`write_text_file`|fn|pub|1776-1787|def write_text_file(dst: Path, text: str) -> None|
|`copy_with_replacements`|fn|pub|1788-1789|def copy_with_replacements(|
|`normalize_description`|fn|pub|1804-1818|def normalize_description(value: str) -> str|
|`md_to_toml`|fn|pub|1819-1853|def md_to_toml(md_path: Path, toml_path: Path, force: boo...|
|`extract_frontmatter`|fn|pub|1854-1867|def extract_frontmatter(content: str) -> tuple[str, str]|
|`extract_description`|fn|pub|1868-1880|def extract_description(frontmatter: str) -> str|
|`extract_argument_hint`|fn|pub|1881-1893|def extract_argument_hint(frontmatter: str) -> str|
|`extract_purpose_first_bullet`|fn|pub|1894-1918|def extract_purpose_first_bullet(body: str) -> str|
|`_extract_section_text`|fn|priv|1919-1946|def _extract_section_text(body: str, section_name: str) -...|
|`extract_skill_description`|fn|pub|1947-1965|def extract_skill_description(frontmatter: str) -> str|
|`json_escape`|fn|pub|1966-1975|def json_escape(value: str) -> str|
|`generate_kiro_resources`|fn|pub|1976-1979|def generate_kiro_resources(|
|`render_kiro_agent`|fn|pub|2005-2014|def render_kiro_agent(|
|`replace_tokens`|fn|pub|2060-2073|def replace_tokens(path: Path, replacements: Mapping[str,...|
|`yaml_double_quote_escape`|fn|pub|2074-2083|def yaml_double_quote_escape(value: str) -> str|
|`list_docs_templates`|fn|pub|2084-2103|def list_docs_templates() -> list[Path]|
|`find_requirements_template`|fn|pub|2104-2120|def find_requirements_template(docs_templates: list[Path]...|
|`load_kiro_template`|fn|pub|2121-2160|def load_kiro_template() -> tuple[str, dict[str, Any]]|
|`strip_json_comments`|fn|pub|2161-2185|def strip_json_comments(text: str) -> str|
|`load_settings`|fn|pub|2186-2201|def load_settings(path: Path) -> dict[str, Any]|
|`load_centralized_models`|fn|pub|2202-2205|def load_centralized_models(|
|`get_model_tools_for_prompt`|fn|pub|2260-2261|def get_model_tools_for_prompt(|
|`get_raw_tools_for_prompt`|fn|pub|2301-2322|def get_raw_tools_for_prompt(config: dict[str, Any] | Non...|
|`format_tools_inline_list`|fn|pub|2323-2334|def format_tools_inline_list(tools: list[str]) -> str|
|`deep_merge_dict`|fn|pub|2335-2350|def deep_merge_dict(base: dict[str, Any], incoming: dict[...|
|`find_vscode_settings_source`|fn|pub|2351-2362|def find_vscode_settings_source() -> Optional[Path]|
|`build_prompt_recommendations`|fn|pub|2363-2377|def build_prompt_recommendations(prompts_dir: Path) -> di...|
|`ensure_wrapped`|fn|pub|2378-2393|def ensure_wrapped(target: Path, project_base: Path, code...|
|`save_vscode_backup`|fn|pub|2394-2408|def save_vscode_backup(req_root: Path, settings_path: Pat...|
|`restore_vscode_settings`|fn|pub|2409-2424|def restore_vscode_settings(project_base: Path) -> None|
|`prune_empty_dirs`|fn|pub|2425-2442|def prune_empty_dirs(root: Path) -> None|
|`remove_generated_resources`|fn|pub|2443-2493|def remove_generated_resources(project_base: Path) -> None|
|`run_remove`|fn|pub|2494-2543|def run_remove(args: Namespace) -> None|
|`_validate_enable_static_check_command_executables`|fn|priv|2544-2547|def _validate_enable_static_check_command_executables(|
|`run`|fn|pub|2576-2775|def run(args: Namespace) -> None|
|`VERBOSE`|var|pub|2585||
|`DEBUG`|var|pub|2586||
|`PROMPT`|var|pub|3070||
|`_format_install_table`|fn|priv|3698-3700|def _format_install_table(|
|`_wrap_cell`|fn|priv|3737-3759|def _wrap_cell(value: str, width: int, allow_wrap: bool) ...|
|`_render_row`|fn|priv|3760-3788|def _render_row(provider: str, prompts: str, modules: str...|
|`_build_provider_modules_map`|fn|priv|3809-3848|def _build_provider_modules_map(provider_specs: list[str]...|
|`_colorize_table_border`|fn|priv|3849-3861|def _colorize_table_border(line: str) -> str|
|`SUPPORTED_EXTENSIONS`|var|pub|3876||
|`_collect_source_files`|fn|priv|3904-3961|def _collect_source_files(src_dirs: list[str], project_ba...|
|`_build_ascii_tree`|fn|priv|3962-4007|def _build_ascii_tree(paths: list[str]) -> str|
|`_emit`|fn|priv|3986-3988|def _emit(|
|`_format_files_structure_markdown`|fn|priv|4008-4022|def _format_files_structure_markdown(files: list[str], pr...|
|`_is_standalone_command`|fn|priv|4023-4041|def _is_standalone_command(args: Namespace) -> bool|
|`_is_project_scan_command`|fn|priv|4042-4064|def _is_project_scan_command(args: Namespace) -> bool|
|`_is_here_only_project_scan_command`|fn|priv|4065-4087|def _is_here_only_project_scan_command(args: Namespace) -...|
|`run_git_check`|fn|pub|4088-4122|def run_git_check(args: Namespace) -> None|
|`run_docs_check`|fn|pub|4123-4152|def run_docs_check(args: Namespace) -> None|
|`run_git_wt_name`|fn|pub|4153-4181|def run_git_wt_name(args: Namespace) -> None|
|`run_git_wt_create`|fn|pub|4182-4249|def run_git_wt_create(args: Namespace) -> None|
|`run_git_wt_delete`|fn|pub|4250-4329|def run_git_wt_delete(args: Namespace) -> None|
|`run_files_tokens`|fn|pub|4330-4352|def run_files_tokens(files: list[str]) -> None|
|`run_files_references`|fn|pub|4353-4369|def run_files_references(files: list[str]) -> None|
|`run_files_compress`|fn|pub|4370-4388|def run_files_compress(files: list[str], enable_line_numb...|
|`run_files_find`|fn|pub|4389-4417|def run_files_find(args_list: list[str], enable_line_numb...|
|`run_references`|fn|pub|4418-4435|def run_references(args: Namespace) -> None|
|`run_compress_cmd`|fn|pub|4436-4457|def run_compress_cmd(args: Namespace) -> None|
|`run_find`|fn|pub|4458-4487|def run_find(args: Namespace) -> None|
|`run_tokens`|fn|pub|4488-4515|def run_tokens(args: Namespace) -> None|
|`run_files_static_check_cmd`|fn|pub|4516-4585|def run_files_static_check_cmd(files: list[str], args: Na...|
|`run_project_static_check_cmd`|fn|pub|4586-4631|def run_project_static_check_cmd(args: Namespace) -> int|
|`_resolve_project_base`|fn|priv|4632-4652|def _resolve_project_base(args: Namespace) -> Path|
|`_resolve_project_src_dirs`|fn|priv|4653-4705|def _resolve_project_src_dirs(args: Namespace) -> tuple[P...|
|`main`|fn|pub|4706-4804|def main(argv: Optional[list[str]] = None) -> int|
|`VERBOSE`|var|pub|4730||
|`DEBUG`|var|pub|4731||
