...
# cli.py | Python | 5273L | 159 symbols | 33 imports | 249 comments
...
### fn `def resolve_provider_configs(` (L128-129)

- var `ANSI_BRIGHT_RED = "\033[91m"` (L180)
...
- fn `def __init__(self, message: str, code: int = 1) -> None` `priv` (L236-248)
  - @brief Dedicated exception for expected CLI errors.
...
### fn `def log(msg: str) -> None` (L249-258)
...
### fn `def dlog(msg: str) -> None` (L259-269)
...
### fn `def vlog(msg: str) -> None` (L270-280)
...
### fn `def _get_available_tags_help() -> str` `priv` (L281-293)
...
### fn `def build_parser() -> argparse.ArgumentParser` (L294-493)
...
### fn `def parse_args(argv: Optional[list[str]] = None) -> Namespace` (L567-576)
...
### fn `def load_package_version() -> str` (L577-591)
...
### fn `def maybe_print_version(argv: list[str]) -> bool` (L592-604)
...
### fn `def run_upgrade() -> None` (L605-639)
...
### fn `def run_uninstall() -> None` (L640-672)
...
### fn `def normalize_release_tag(tag: str) -> str` (L673-685)
...
### fn `def parse_version_tuple(version: str) -> tuple[int, ...] | None` (L686-710)
...
### fn `def is_newer_version(current: str, latest: str) -> bool` (L711-729)
...
### fn `def parse_github_owner_repository(remote_url: str) -> tuple[str, str] | None` (L730-756)
...
### fn `def read_git_remote_verbose(cwd: str | None = None) -> str` (L757-776)
...
### fn `def resolve_github_owner_repository_from_active_remotes() -> tuple[str, str]` (L777-837)
...
### fn `def resolve_latest_release_api_url() -> str` (L838-846)
...
### fn `def format_unix_timestamp_utc(timestamp_seconds: int) -> str` (L847-859)
...
### fn `def get_release_check_idle_file_path(` (L860-861)

### fn `def cleanup_release_check_idle_state_cache(` (L878-879)
...
### fn `def read_release_check_idle_state(file_path: Path) -> dict[str, int | str] | None` (L902-966)
...
### fn `def should_execute_release_check(` (L967-969)

### fn `def parse_retry_after_seconds(` (L988-990)
...
### fn `def write_release_check_idle_state_payload(` (L1020-1023)
...
### fn `def write_release_check_idle_state(` (L1050-1053)
...
### fn `def write_failed_release_check_idle_state(` (L1072-1076)
...
### fn `def persist_failed_release_check_idle_state(` (L1104-1108)
...
### fn `def maybe_notify_newer_version(` (L1134-1135)
...
### fn `def ensure_doc_directory(path: str, project_base: Path) -> None` (L1288-1310)
...
### fn `def ensure_test_directory(path: str, project_base: Path) -> None` (L1311-1333)
...
### fn `def ensure_src_directory(path: str, project_base: Path) -> None` (L1334-1356)
...
### fn `def make_relative_if_contains_project(path_value: str, project_base: Path) -> str` (L1357-1398)
...
### fn `def resolve_absolute(normalized: str, project_base: Path) -> Optional[Path]` (L1399-1414)
...
### fn `def format_substituted_path(value: str) -> str` (L1415-1426)
...
### fn `def compute_sub_path(` (L1427-1428)

### fn `def resolve_git_root(target_path: Path) -> Path` (L1449-1476)
...
### fn `def is_inside_git_repo(target_path: Path) -> bool` (L1477-1496)
...
### fn `def sanitize_branch_name(branch: str) -> str` (L1497-1506)
...
### fn `def validate_wt_name(wt_name: str) -> bool` (L1507-1518)
...
### fn `def load_full_config(project_base: Path) -> dict` (L1519-1538)
...
### fn `def save_config(` (L1539-1549)

### fn `def load_config(project_base: Path) -> dict[str, str | list[str]]` (L1593-1643)
...
### fn `def load_static_check_from_config(project_base: Path) -> dict` (L1644-1675)
...
### fn `def _static_check_entry_identity(` `priv` (L1676-1677)

### fn `def build_persisted_update_flags(args: Namespace) -> dict[str, bool]` (L1700-1713)
...
### fn `def load_persisted_update_flags(project_base: Path) -> dict[str, bool]` (L1714-1755)
...
### fn `def load_persisted_provider_specs(project_base: Path) -> list[str]` (L1756-1777)
...
### fn `def generate_guidelines_file_list(guidelines_dir: Path, project_base: Path) -> str` (L1778-1810)
...
### fn `def generate_guidelines_file_items(` (L1811-1812)

### fn `def upgrade_guidelines_templates(guidelines_dest: Path, overwrite: bool = False) -> int` (L1846-1880)
...
### fn `def make_relative_token(raw: str, keep_trailing: bool = False) -> str` (L1881-1897)
...
### fn `def ensure_relative(value: str, name: str, code: int) -> None` (L1898-1913)
...
### fn `def apply_replacements(text: str, replacements: Mapping[str, str]) -> str` (L1914-1926)
...
### fn `def write_text_file(dst: Path, text: str) -> None` (L1927-1938)
...
### fn `def copy_with_replacements(` (L1939-1940)

### fn `def normalize_description(value: str) -> str` (L1955-1969)
...
### fn `def md_to_toml(md_path: Path, toml_path: Path, force: bool) -> None` (L1970-2004)
...
### fn `def extract_frontmatter(content: str) -> tuple[str, str]` (L2005-2018)
...
### fn `def extract_description(frontmatter: str) -> str` (L2019-2031)
...
### fn `def extract_argument_hint(frontmatter: str) -> str` (L2032-2044)
...
### fn `def extract_purpose_first_bullet(body: str) -> str` (L2045-2069)
...
### fn `def _extract_section_text(body: str, section_name: str) -> str` `priv` (L2070-2097)
...
### fn `def extract_skill_description(frontmatter: str) -> str` (L2098-2116)
...
### fn `def json_escape(value: str) -> str` (L2117-2126)
...
### fn `def generate_kiro_resources(` (L2127-2130)

### fn `def render_kiro_agent(` (L2156-2165)
...
### fn `def replace_tokens(path: Path, replacements: Mapping[str, str]) -> None` (L2211-2224)
...
### fn `def yaml_double_quote_escape(value: str) -> str` (L2225-2234)
...
### fn `def list_docs_templates() -> list[Path]` (L2235-2254)
...
### fn `def find_requirements_template(docs_templates: list[Path]) -> Path` (L2255-2271)
...
### fn `def load_kiro_template() -> tuple[str, dict[str, Any]]` (L2272-2311)
...
### fn `def strip_json_comments(text: str) -> str` (L2312-2336)
...
### fn `def load_settings(path: Path) -> dict[str, Any]` (L2337-2352)
...
### fn `def load_centralized_models(` (L2353-2356)

### fn `def get_model_tools_for_prompt(` (L2427-2428)
...
### fn `def get_raw_tools_for_prompt(config: dict[str, Any] | None, prompt_name: str) -> Any` (L2468-2489)
...
### fn `def format_tools_inline_list(tools: list[str]) -> str` (L2490-2501)
...
### fn `def deep_merge_dict(base: dict[str, Any], incoming: dict[str, Any]) -> dict[str, Any]` (L2502-2517)
...
### fn `def find_vscode_settings_source() -> Optional[Path]` (L2518-2529)
...
### fn `def build_prompt_recommendations(prompts_dir: Path) -> dict[str, bool]` (L2530-2544)
...
### fn `def ensure_wrapped(target: Path, project_base: Path, code: int) -> None` (L2545-2560)
...
### fn `def save_vscode_backup(req_root: Path, settings_path: Path) -> None` (L2561-2575)
...
### fn `def restore_vscode_settings(project_base: Path) -> None` (L2576-2591)
...
### fn `def prune_empty_dirs(root: Path) -> None` (L2592-2609)
...
### fn `def remove_generated_resources(project_base: Path) -> None` (L2610-2662)
...
### fn `def run_remove(args: Namespace) -> None` (L2663-2713)
...
### fn `def _validate_enable_static_check_command_executables(` `priv` (L2714-2717)

### fn `def run(args: Namespace) -> None` (L2746-2945)
...
- var `VERBOSE = args.verbose` (L2755)
- @brief Handles the main initialization flow.
- @details Validates input arguments, normalizes paths, and orchestrates resource generation per provider and artifact type. Requires at least one ``--provider`` spec (SRS-035). Deduplicates ``--enable-static-check`` entries (SRS-251, SRS-301).
- @param args Parsed CLI namespace; must contain ``provider_specs`` list and ``preserve_models`` boolean.
- @return {None} Function return value.
- @satisfies SRS-251, SRS-301
- var `DEBUG = args.debug` (L2756)
- var `PROMPT = prompt_path.stem` (L3271)
### fn `def _format_install_table(` `priv` (L3963-3965)

### fn `def _wrap_cell(value: str, width: int, allow_wrap: bool) -> list[str]` `priv` (L4002-4024)
...
### fn `def _render_row(provider: str, prompts: str, modules: str) -> list[str]` `priv` (L4025-4051)
...
### fn `def _build_provider_modules_map(provider_specs: list[str]) -> dict[str, list[str]]` `priv` (L4066-4115)
...
### fn `def _colorize_table_border(line: str) -> str` `priv` (L4116-4128)
...
- var `SUPPORTED_EXTENSIONS = frozenset(` (L4143)
### fn `def _collect_source_files(src_dirs: list[str], project_base: Path) -> list[str]` `priv` (L4171-4228)
...
### fn `def _build_ascii_tree(paths: list[str]) -> str` `priv` (L4229-4274)
...
### fn `def _emit(` `priv` (L4253-4255)
- @brief Build a deterministic tree string from project-relative paths.
- @details Implements the _build_ascii_tree function behavior with deterministic control flow.
- @param paths Project-relative file paths.
- @return Rendered tree rooted at '.'.

### fn `def _format_files_structure_markdown(files: list[str], project_base: Path) -> str` `priv` (L4275-4289)
...
### fn `def _is_standalone_command(args: Namespace) -> bool` `priv` (L4290-4308)
...
### fn `def _is_project_scan_command(args: Namespace) -> bool` `priv` (L4309-4333)
...
### fn `def _is_here_only_project_scan_command(args: Namespace) -> bool` `priv` (L4334-4359)
...
### fn `def run_git_check(args: Namespace) -> None` (L4360-4391)
...
### fn `def run_docs_check(args: Namespace) -> None` (L4392-4421)
...
### fn `def run_git_wt_name(args: Namespace) -> None` (L4422-4450)
- @brief Execute --git-wt-name: print standardized worktree name.
- @param args Parsed CLI namespace.
- @return {None} Function return value.
- @satisfies SRS-318, SRS-319

### fn `def _worktree_path_exists_exact(git_path: Path, target_path: Path) -> bool` `priv` (L4451-4480)
...
### fn `def _rollback_worktree_create(git_path: Path, wt_path: Path, wt_name: str) -> None` `priv` (L4481-4517)
...
### fn `def run_git_wt_create(args: Namespace) -> None` (L4518-4617)
...
### fn `def run_git_wt_delete(args: Namespace) -> None` (L4618-4695)
...
### fn `def run_git_path(args: Namespace) -> None` (L4696-4708)
...
### fn `def run_get_base_path(args: Namespace) -> None` (L4709-4721)
...
### fn `def run_files_tokens(files: list[str]) -> None` (L4722-4744)
...
### fn `def run_files_references(files: list[str]) -> None` (L4745-4761)
...
### fn `def run_files_compress(files: list[str], enable_line_numbers: bool = False) -> None` (L4762-4780)
...
### fn `def run_files_find(args_list: list[str], enable_line_numbers: bool = False) -> None` (L4781-4809)
...
### fn `def run_references(args: Namespace) -> None` (L4810-4827)
...
### fn `def run_compress_cmd(args: Namespace) -> None` (L4828-4849)
...
### fn `def run_find(args: Namespace) -> None` (L4850-4879)
...
### fn `def run_tokens(args: Namespace) -> None` (L4880-4907)
...
### fn `def run_files_static_check_cmd(files: list[str], args: Namespace) -> int` (L4908-4985)
...
### fn `def run_project_static_check_cmd(args: Namespace) -> int` (L4986-5085)
...
### fn `def _resolve_project_base(args: Namespace) -> Path` `priv` (L5086-5106)
...
### fn `def _resolve_project_src_dirs(args: Namespace) -> tuple[Path, list[str]]` `priv` (L5107-5159)
...
### fn `def main(argv: Optional[list[str]] = None) -> int` (L5160-5271)
...
- var `FORCE_ONLINE_RELEASE_CHECK = force_online_release_check` (L5174)
- @brief CLI entry point for console_scripts and `-m` execution.
- @details Returns an exit code (0 success, non-zero on error).
- @param argv Input parameter `argv`.
- @return {int} Function return value.
- var `FORCE_ONLINE_RELEASE_CHECK = previous_force_online_release_check` (L5178)
- var `VERBOSE = getattr(args, "verbose", False)` (L5191)
- var `DEBUG = getattr(args, "debug", False)` (L5192)
## Symbol Index
|Symbol|Kind|Vis|Lines|Sig|
|---|---|---|---|---|
...
|`VALID_ARTIFACTS`|var|pub|53||
|`VALID_PROVIDER_OPTIONS`|var|pub|56||
|`INVALID_WT_NAME_RE`|var|pub|72||
|`parse_provider_spec`|fn|pub|76-127|def parse_provider_spec(spec: str) -> tuple[str, set[str]...|
|`resolve_provider_configs`|fn|pub|128-129|def resolve_provider_configs(|
|`ANSI_BRIGHT_RED`|var|pub|180||
|`ANSI_BRIGHT_GREEN`|var|pub|183||
|`ANSI_RESET`|var|pub|186||
|`RELEASE_CHECK_TIMEOUT_SECONDS`|var|pub|189||
|`RELEASE_CHECK_IDLE_DELAY_SECONDS`|var|pub|192||
|`RELEASE_CHECK_RATE_LIMIT_IDLE_DELAY_SECONDS`|var|pub|195||
|`TOOL_PROGRAM_NAME`|var|pub|198||
|`RELEASE_CHECK_PROGRAM_NAME`|var|pub|201||
|`GITHUB_REPOSITORY_OWNER`|var|pub|204||
|`GITHUB_REPOSITORY_NAME`|var|pub|207||
|`RELEASE_CHECK_IDLE_CACHE_ROOT_DIRNAME`|var|pub|210||
|`RELEASE_CHECK_IDLE_FILENAME`|var|pub|213||
|`GITHUB_RELEASES_LATEST_URL`|var|pub|216||
|`GITHUB_UPGRADE_SOURCE`|var|pub|222||
|`FORCE_ONLINE_RELEASE_CHECK`|var|pub|227||
|`ReqError`|class|pub|231-248|class ReqError(Exception)|
|`ReqError.__init__`|fn|priv|236-248|def __init__(self, message: str, code: int = 1) -> None|
|`log`|fn|pub|249-258|def log(msg: str) -> None|
|`dlog`|fn|pub|259-269|def dlog(msg: str) -> None|
|`vlog`|fn|pub|270-280|def vlog(msg: str) -> None|
|`_get_available_tags_help`|fn|priv|281-293|def _get_available_tags_help() -> str|
|`build_parser`|fn|pub|294-493|def build_parser() -> argparse.ArgumentParser|
|`parse_args`|fn|pub|567-576|def parse_args(argv: Optional[list[str]] = None) -> Names...|
|`load_package_version`|fn|pub|577-591|def load_package_version() -> str|
|`maybe_print_version`|fn|pub|592-604|def maybe_print_version(argv: list[str]) -> bool|
|`run_upgrade`|fn|pub|605-639|def run_upgrade() -> None|
|`run_uninstall`|fn|pub|640-672|def run_uninstall() -> None|
|`normalize_release_tag`|fn|pub|673-685|def normalize_release_tag(tag: str) -> str|
|`parse_version_tuple`|fn|pub|686-710|def parse_version_tuple(version: str) -> tuple[int, ...] ...|
|`is_newer_version`|fn|pub|711-729|def is_newer_version(current: str, latest: str) -> bool|
|`parse_github_owner_repository`|fn|pub|730-756|def parse_github_owner_repository(remote_url: str) -> tup...|
|`read_git_remote_verbose`|fn|pub|757-776|def read_git_remote_verbose(cwd: str | None = None) -> str|
|`resolve_github_owner_repository_from_active_remotes`|fn|pub|777-837|def resolve_github_owner_repository_from_active_remotes()...|
|`resolve_latest_release_api_url`|fn|pub|838-846|def resolve_latest_release_api_url() -> str|
|`format_unix_timestamp_utc`|fn|pub|847-859|def format_unix_timestamp_utc(timestamp_seconds: int) -> str|
|`get_release_check_idle_file_path`|fn|pub|860-861|def get_release_check_idle_file_path(|
|`cleanup_release_check_idle_state_cache`|fn|pub|878-879|def cleanup_release_check_idle_state_cache(|
|`read_release_check_idle_state`|fn|pub|902-966|def read_release_check_idle_state(file_path: Path) -> dic...|
|`should_execute_release_check`|fn|pub|967-969|def should_execute_release_check(|
|`parse_retry_after_seconds`|fn|pub|988-990|def parse_retry_after_seconds(|
|`write_release_check_idle_state_payload`|fn|pub|1020-1023|def write_release_check_idle_state_payload(|
|`write_release_check_idle_state`|fn|pub|1050-1053|def write_release_check_idle_state(|
|`write_failed_release_check_idle_state`|fn|pub|1072-1076|def write_failed_release_check_idle_state(|
|`persist_failed_release_check_idle_state`|fn|pub|1104-1108|def persist_failed_release_check_idle_state(|
|`maybe_notify_newer_version`|fn|pub|1134-1135|def maybe_notify_newer_version(|
|`ensure_doc_directory`|fn|pub|1288-1310|def ensure_doc_directory(path: str, project_base: Path) -...|
|`ensure_test_directory`|fn|pub|1311-1333|def ensure_test_directory(path: str, project_base: Path) ...|
|`ensure_src_directory`|fn|pub|1334-1356|def ensure_src_directory(path: str, project_base: Path) -...|
|`make_relative_if_contains_project`|fn|pub|1357-1398|def make_relative_if_contains_project(path_value: str, pr...|
|`resolve_absolute`|fn|pub|1399-1414|def resolve_absolute(normalized: str, project_base: Path)...|
|`format_substituted_path`|fn|pub|1415-1426|def format_substituted_path(value: str) -> str|
|`compute_sub_path`|fn|pub|1427-1428|def compute_sub_path(|
|`resolve_git_root`|fn|pub|1449-1476|def resolve_git_root(target_path: Path) -> Path|
|`is_inside_git_repo`|fn|pub|1477-1496|def is_inside_git_repo(target_path: Path) -> bool|
|`sanitize_branch_name`|fn|pub|1497-1506|def sanitize_branch_name(branch: str) -> str|
|`validate_wt_name`|fn|pub|1507-1518|def validate_wt_name(wt_name: str) -> bool|
|`load_full_config`|fn|pub|1519-1538|def load_full_config(project_base: Path) -> dict|
|`save_config`|fn|pub|1539-1549|def save_config(|
|`load_config`|fn|pub|1593-1643|def load_config(project_base: Path) -> dict[str, str | li...|
|`load_static_check_from_config`|fn|pub|1644-1675|def load_static_check_from_config(project_base: Path) -> ...|
|`_static_check_entry_identity`|fn|priv|1676-1677|def _static_check_entry_identity(|
|`build_persisted_update_flags`|fn|pub|1700-1713|def build_persisted_update_flags(args: Namespace) -> dict...|
|`load_persisted_update_flags`|fn|pub|1714-1755|def load_persisted_update_flags(project_base: Path) -> di...|
|`load_persisted_provider_specs`|fn|pub|1756-1777|def load_persisted_provider_specs(project_base: Path) -> ...|
|`generate_guidelines_file_list`|fn|pub|1778-1810|def generate_guidelines_file_list(guidelines_dir: Path, p...|
|`generate_guidelines_file_items`|fn|pub|1811-1812|def generate_guidelines_file_items(|
|`upgrade_guidelines_templates`|fn|pub|1846-1880|def upgrade_guidelines_templates(guidelines_dest: Path, o...|
|`make_relative_token`|fn|pub|1881-1897|def make_relative_token(raw: str, keep_trailing: bool = F...|
|`ensure_relative`|fn|pub|1898-1913|def ensure_relative(value: str, name: str, code: int) -> ...|
|`apply_replacements`|fn|pub|1914-1926|def apply_replacements(text: str, replacements: Mapping[s...|
|`write_text_file`|fn|pub|1927-1938|def write_text_file(dst: Path, text: str) -> None|
|`copy_with_replacements`|fn|pub|1939-1940|def copy_with_replacements(|
|`normalize_description`|fn|pub|1955-1969|def normalize_description(value: str) -> str|
|`md_to_toml`|fn|pub|1970-2004|def md_to_toml(md_path: Path, toml_path: Path, force: boo...|
|`extract_frontmatter`|fn|pub|2005-2018|def extract_frontmatter(content: str) -> tuple[str, str]|
|`extract_description`|fn|pub|2019-2031|def extract_description(frontmatter: str) -> str|
|`extract_argument_hint`|fn|pub|2032-2044|def extract_argument_hint(frontmatter: str) -> str|
|`extract_purpose_first_bullet`|fn|pub|2045-2069|def extract_purpose_first_bullet(body: str) -> str|
|`_extract_section_text`|fn|priv|2070-2097|def _extract_section_text(body: str, section_name: str) -...|
|`extract_skill_description`|fn|pub|2098-2116|def extract_skill_description(frontmatter: str) -> str|
|`json_escape`|fn|pub|2117-2126|def json_escape(value: str) -> str|
|`generate_kiro_resources`|fn|pub|2127-2130|def generate_kiro_resources(|
|`render_kiro_agent`|fn|pub|2156-2165|def render_kiro_agent(|
|`replace_tokens`|fn|pub|2211-2224|def replace_tokens(path: Path, replacements: Mapping[str,...|
|`yaml_double_quote_escape`|fn|pub|2225-2234|def yaml_double_quote_escape(value: str) -> str|
|`list_docs_templates`|fn|pub|2235-2254|def list_docs_templates() -> list[Path]|
|`find_requirements_template`|fn|pub|2255-2271|def find_requirements_template(docs_templates: list[Path]...|
|`load_kiro_template`|fn|pub|2272-2311|def load_kiro_template() -> tuple[str, dict[str, Any]]|
|`strip_json_comments`|fn|pub|2312-2336|def strip_json_comments(text: str) -> str|
|`load_settings`|fn|pub|2337-2352|def load_settings(path: Path) -> dict[str, Any]|
|`load_centralized_models`|fn|pub|2353-2356|def load_centralized_models(|
|`get_model_tools_for_prompt`|fn|pub|2427-2428|def get_model_tools_for_prompt(|
|`get_raw_tools_for_prompt`|fn|pub|2468-2489|def get_raw_tools_for_prompt(config: dict[str, Any] | Non...|
|`format_tools_inline_list`|fn|pub|2490-2501|def format_tools_inline_list(tools: list[str]) -> str|
|`deep_merge_dict`|fn|pub|2502-2517|def deep_merge_dict(base: dict[str, Any], incoming: dict[...|
|`find_vscode_settings_source`|fn|pub|2518-2529|def find_vscode_settings_source() -> Optional[Path]|
|`build_prompt_recommendations`|fn|pub|2530-2544|def build_prompt_recommendations(prompts_dir: Path) -> di...|
|`ensure_wrapped`|fn|pub|2545-2560|def ensure_wrapped(target: Path, project_base: Path, code...|
|`save_vscode_backup`|fn|pub|2561-2575|def save_vscode_backup(req_root: Path, settings_path: Pat...|
|`restore_vscode_settings`|fn|pub|2576-2591|def restore_vscode_settings(project_base: Path) -> None|
|`prune_empty_dirs`|fn|pub|2592-2609|def prune_empty_dirs(root: Path) -> None|
|`remove_generated_resources`|fn|pub|2610-2662|def remove_generated_resources(project_base: Path) -> None|
|`run_remove`|fn|pub|2663-2713|def run_remove(args: Namespace) -> None|
|`_validate_enable_static_check_command_executables`|fn|priv|2714-2717|def _validate_enable_static_check_command_executables(|
|`run`|fn|pub|2746-2945|def run(args: Namespace) -> None|
|`VERBOSE`|var|pub|2755||
|`DEBUG`|var|pub|2756||
|`PROMPT`|var|pub|3271||
|`_format_install_table`|fn|priv|3963-3965|def _format_install_table(|
|`_wrap_cell`|fn|priv|4002-4024|def _wrap_cell(value: str, width: int, allow_wrap: bool) ...|
|`_render_row`|fn|priv|4025-4051|def _render_row(provider: str, prompts: str, modules: str...|
|`_build_provider_modules_map`|fn|priv|4066-4115|def _build_provider_modules_map(provider_specs: list[str]...|
|`_colorize_table_border`|fn|priv|4116-4128|def _colorize_table_border(line: str) -> str|
|`SUPPORTED_EXTENSIONS`|var|pub|4143||
|`_collect_source_files`|fn|priv|4171-4228|def _collect_source_files(src_dirs: list[str], project_ba...|
|`_build_ascii_tree`|fn|priv|4229-4274|def _build_ascii_tree(paths: list[str]) -> str|
|`_emit`|fn|priv|4253-4255|def _emit(|
|`_format_files_structure_markdown`|fn|priv|4275-4289|def _format_files_structure_markdown(files: list[str], pr...|
|`_is_standalone_command`|fn|priv|4290-4308|def _is_standalone_command(args: Namespace) -> bool|
|`_is_project_scan_command`|fn|priv|4309-4333|def _is_project_scan_command(args: Namespace) -> bool|
|`_is_here_only_project_scan_command`|fn|priv|4334-4359|def _is_here_only_project_scan_command(args: Namespace) -...|
|`run_git_check`|fn|pub|4360-4391|def run_git_check(args: Namespace) -> None|
|`run_docs_check`|fn|pub|4392-4421|def run_docs_check(args: Namespace) -> None|
|`run_git_wt_name`|fn|pub|4422-4450|def run_git_wt_name(args: Namespace) -> None|
|`_worktree_path_exists_exact`|fn|priv|4451-4480|def _worktree_path_exists_exact(git_path: Path, target_pa...|
|`_rollback_worktree_create`|fn|priv|4481-4517|def _rollback_worktree_create(git_path: Path, wt_path: Pa...|
|`run_git_wt_create`|fn|pub|4518-4617|def run_git_wt_create(args: Namespace) -> None|
|`run_git_wt_delete`|fn|pub|4618-4695|def run_git_wt_delete(args: Namespace) -> None|
|`run_git_path`|fn|pub|4696-4708|def run_git_path(args: Namespace) -> None|
|`run_get_base_path`|fn|pub|4709-4721|def run_get_base_path(args: Namespace) -> None|
|`run_files_tokens`|fn|pub|4722-4744|def run_files_tokens(files: list[str]) -> None|
|`run_files_references`|fn|pub|4745-4761|def run_files_references(files: list[str]) -> None|
|`run_files_compress`|fn|pub|4762-4780|def run_files_compress(files: list[str], enable_line_numb...|
|`run_files_find`|fn|pub|4781-4809|def run_files_find(args_list: list[str], enable_line_numb...|
|`run_references`|fn|pub|4810-4827|def run_references(args: Namespace) -> None|
|`run_compress_cmd`|fn|pub|4828-4849|def run_compress_cmd(args: Namespace) -> None|
|`run_find`|fn|pub|4850-4879|def run_find(args: Namespace) -> None|
|`run_tokens`|fn|pub|4880-4907|def run_tokens(args: Namespace) -> None|
|`run_files_static_check_cmd`|fn|pub|4908-4985|def run_files_static_check_cmd(files: list[str], args: Na...|
|`run_project_static_check_cmd`|fn|pub|4986-5085|def run_project_static_check_cmd(args: Namespace) -> int|
|`_resolve_project_base`|fn|priv|5086-5106|def _resolve_project_base(args: Namespace) -> Path|
|`_resolve_project_src_dirs`|fn|priv|5107-5159|def _resolve_project_src_dirs(args: Namespace) -> tuple[P...|
|`main`|fn|pub|5160-5271|def main(argv: Optional[list[str]] = None) -> int|
|`FORCE_ONLINE_RELEASE_CHECK`|var|pub|5174||
|`FORCE_ONLINE_RELEASE_CHECK`|var|pub|5178||
|`VERBOSE`|var|pub|5191||
|`DEBUG`|var|pub|5192||
