...
# cli.py | Python | 5015L | 151 symbols | 32 imports | 241 comments
...
### fn `def main(argv: Optional[list[str]] = None) -> int` (L4911-5013)
...
|`main`|fn|pub|4911-5013|def main(argv: Optional[list[str]] = None) -> int|
