...
2. Generate the **Software Requirements Specification**
   ...
   - Read the **Software Requirements Specification** document %%REQ_DIR%% and extract a complete, explicit list of atomic requirements.
   ...
   - Create or overwrite the **Software Requirements Specification** document with the recreated requirements draft at `%%REQ_PATH%%/requirements_DRAFT.md`.   
   ...
   - Re-number all requirements in `%%REQ_PATH%%/requirements_DRAFT.md` and preserve all cross-references.
