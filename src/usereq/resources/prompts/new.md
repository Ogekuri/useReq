...
3. Generate and apply the **Software Requirements Specification Update** to cover new requirements
   ...
   - APPLY the **Software Requirements Specification Update** to `%%DOC_PATH%%/REQUIREMENTS.md`, following its formatting, language, and guidelines from the template at `.req/docs/requirements.md`. Do NOT introduce any additional edits beyond what the **Software Requirements Specification Update** describes.
