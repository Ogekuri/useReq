...
1.  Confirm the repo is clean with `git status --porcelain`, If NOT empty override the final line with EXACTLY "WARNING: New implementation completed with unclean git repository!".
