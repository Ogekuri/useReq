...
3. Generate and apply the **Software Requirements Specification Update** to change requirements
   ...
   - APPLY the **Software Requirements Specification Update** to %%REQ_DIR%%, following its formatting, language, and guidelines. Do NOT introduce any additional edits beyond what the **Software Requirements Specification Update** describes.
